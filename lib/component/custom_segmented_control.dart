...
/// See also:
///
///  * [MiAidCupertinoSegmentedControl], a segmented control widget in the style used
///    up until iOS 13.
///  * <https://developer.apple.com/design/human-interface-guidelines/ios/controls/segmented-controls/>
class MiAidCupertinoSegmentedControl<T> extends StatefulWidget {
  ...
  /// in the [children] map.
  MiAidCupertinoSegmentedControl({
    Key key,
...
class _SegmentedControlState<T> extends State<MiAidCupertinoSegmentedControl<T>>
    with TickerProviderStateMixin<MiAidCupertinoSegmentedControl<T>> {
  T _pressedKey;
  ...
  @override
  void didUpdateWidget(MiAidCupertinoSegmentedControl<T> oldWidget) {
